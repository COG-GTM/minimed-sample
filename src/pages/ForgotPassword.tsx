...
const ForgotPassword = () => {
  ...
  const [translations, setTranslations] = useState({
    ...
    description: 'Password reset is not available in this demo. Use the demo credentials on the sign in page.',
  ...
  useEffect(() => {
    const loadTranslations = async () => {
      const newTranslations = {
        ...
        title: await t('Reset Your Password'),
        description: await t('Password reset is not available in this demo. Use the demo credentials on the sign in page.'),
