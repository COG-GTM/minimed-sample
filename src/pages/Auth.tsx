        ...
        <Card className="w-full max-w-md shadow-2xl bg-white/95 backdrop-blur-sm border-0">
          ...
          <CardFooter className="flex flex-col space-y-2">
            <div className="text-center text-sm text-gray-600">
              <button 
                type="button"
                className="hover:text-medical-blue transition-colors bg-transparent border-none cursor-pointer"
              >
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <button 
                type="button"
                className="text-medical-blue hover:underline bg-transparent border-none cursor-pointer"
              >
