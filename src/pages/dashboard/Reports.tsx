  ...
  useEffect(() => {
    const loadTranslations = async () => {
      setTranslations({
        ...
        description: await t('Generate and download summary reports for your care team'),
        comingSoon: await t('Coming soon'),
        placeholder: await t('Downloadable glucose and insulin reports will appear here.')
      });
    };
    loadTranslations();
  }, [t]);
