...
import { Activity, Droplet, Minus, ArrowDown, ArrowUp, Zap } from 'lucide-react';
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium">
                    {deviceStatus ? `${deviceStatus.batteryLevel.toFixed(0)}%` : '--'}
                  </span>
                </div>
              </div>
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">
                  {deviceStatus ? `${deviceStatus.reservoirLevel.toFixed(0)}U` : '--'}
                </span>
              </div>
            </div>
          </CardContent>
