...
const ReportsSection = () => {
  ...
  const [translations, setTranslations] = useState({
    title: 'Reports',
    description: 'View detailed reports and analytics of your diabetes management data.',
  ...
  useEffect(() => {
    const load = async () => {
      setTranslations({
        ...
        description: await t('View detailed reports and analytics of your diabetes management data.'),
