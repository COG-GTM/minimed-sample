...
const SettingsSection = () => {
  ...
  const [translations, setTranslations] = useState({
    title: 'Settings',
    description: 'Configure your dashboard preferences, notifications, and device settings.',
  ...
  useEffect(() => {
    const load = async () => {
      setTranslations({
        ...
        description: await t('Configure your dashboard preferences, notifications, and device settings.'),
