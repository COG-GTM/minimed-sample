...
const InsulinManagementSection = () => {
  ...
  const [translations, setTranslations] = useState({
    ...
    description: 'Manage your insulin delivery with smart automated systems.',
  ...
  useEffect(() => {
    const load = async () => {
      setTranslations({
        ...
        description: await t('Manage your insulin delivery with smart automated systems.'),
