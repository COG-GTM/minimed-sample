        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => navigate('/auth')} className="text-white/90 hover:text-white transition-colors font-medium">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-4 py-2 space-y-1">
              ...
              <button onClick={() => { navigate('/auth'); setMobileMenuOpen(false); }} className="block py-2 text-gray-600 text-left">
                {tSync('nav.healthcare')}
              </button>
              <div className="py-2">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a onClick={() => navigate('/auth')} role="button" className="hover:text-white transition-colors cursor-pointer">CareLink Software</a></li>
              </ul>
            </div>
            <div>
