        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a onClick={() => navigate('/auth')} className="cursor-pointer text-white/90 hover:text-white transition-colors font-medium">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-4 py-2 space-y-1">
              ...
              <a onClick={() => navigate('/auth')} className="block cursor-pointer py-2 text-gray-600">
                {tSync('nav.healthcare')}
              </a>
              <div className="py-2">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a onClick={() => navigate('/auth')} className="cursor-pointer hover:text-white transition-colors">CareLink Software</a></li>
              </ul>
            </div>
            <div>
