        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-4 py-2 space-y-1">
              ...
              <button onClick={() => { navigate('/auth'); setMobileMenuOpen(false); }} className="block py-2 text-gray-600 text-left w-full">
                {tSync('nav.healthcare')}
              </button>
              <div className="py-2">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><button onClick={() => navigate('/auth')} className="hover:text-white transition-colors">CareLink Software</button></li>
              </ul>
            </div>
            <div>
