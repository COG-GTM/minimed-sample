...
const DashboardLayout = () => {
  ...
  const sidebarItems = [
    { icon: Home, label: translations.overview, path: '/dashboard', end: true },
    ...
    { icon: Wifi, label: translations.deviceStatus, path: '/dashboard/devices' },
            ...
            <nav className="space-y-1">
              {sidebarItems.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) => `w-full flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors ${
                    isActive
